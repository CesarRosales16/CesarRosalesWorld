...
//    ArrayList<Edificacion> edificaciones = new ArrayList<>();
    ...
    public void construirEdificacionVehiculos(int fase, int tipo) {
        ...
        switch (tipo) {
            case 1:
                ...
                Edificacion taller1 = directorE.getEdificacion("Taller de taques", 900, 200, 117, 0, fase, vehiculosT1, 3);
            ...
            case 2:
                ...
                Edificacion taller2 = directorE.getEdificacion("Taller de furgonetas", 900, 135, 69, 0, fase, vehiculosT2, 3);
    ...
    public void constriurEdificacionRecursos(int fase, int tipo) {
        ...
        switch (tipo) {
            case 1:
                ...
                Edificacion recR1 = directorE.getEdificacion("Recolector de piedra", 1000, 300, 200, 0, fase, recolectoresT1, 0);
                if (cm.getCantR1() >= recR1.getCostoR1() && cm.getCantR2() >= recR1.getCostoR2() && cm.getCantR3() >= recR1.getCostoR3()) {
                    ...
                    Recurso rec1 = directorR.getRecurso("Piedra", 25, fase);
            ...
            case 2:
                ...
                Edificacion recR2 = directorE.getEdificacion("Recolector de estramonio", 1000, 150, 200, 0, fase, recolectoresT2, 0);
                if (cm.getCantR1() >= recR2.getCostoR1() && cm.getCantR2() >= recR2.getCostoR2() && cm.getCantR3() >= recR2.getCostoR3()) {
                    ...
                    Recurso rec2 = directorR.getRecurso("Estramonio", 40, fase);
            ...
            case 3:
                ...
                Edificacion gen1 = directorE.getEdificacion("Generador de minerales", 1000, 150, 300, 25, fase, generadoresT3, 0);
                if (cm.getCantR1() >= gen1.getCostoR1() && cm.getCantR2() >= gen1.getCostoR2() && cm.getCantR3() >= gen1.getCostoR3()) {
                    ...
                    Recurso rec3 = directorR.getRecurso("Minerales", 60, fase);
    ...
    public void entrenarTropaEscuadron(int fase) {
        ...
        Milicia tropa1 = directorM.getMilicia("Infectado", 1000, 300, 200, 100, 75, 25, fase, 2);
    ...
    public void entrenarSupersoldado(int fase) {
        if (flagSupersoldado == 0) {
            DirectorMilicia directorM = new DirectorMilicia();
            Milicia supersoldado = directorM.getMilicia("El Padre", 1000, 500, 300, 100, 75, 150, fase, 2);
    ...
    public void construirVehiculosTipo1(int fase) {
        ...
        Vehiculo v1 = directorV.getVehiculo("Tanques", 1000, 130, 100, 150, 75, fase, 4);
    ...
    public void construirVehiculosTipo2(int fase) {
        DirectorVehiculo directorV = new DirectorVehiculo();
        Vehiculo v2 = directorV.getVehiculo("Furgonetas", 1000, 130, 70, 150, 50, fase, 4);
